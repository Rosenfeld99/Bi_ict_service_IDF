...
export default function HorizontalProgressBar({ title, perValue, colorBar }) {
    return (
        <div className="bg-primary flex items-center justify-center gap-2 p-3 lg:px-8 rounded-lg">
            <div className=" flex flex-col items-center justify-center gap-5 mx-2">
                <div className=" text-xl font-semibold p-3 rounded-full shadow-lg">{perValue + "%"}</div>
