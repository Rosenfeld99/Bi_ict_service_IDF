...
const ProgressPei = ({ perValue, color, size,widthPei,sizeOfText }) => {
    return (
        <div className=" relative">
            <div className={`radial-progress ${color} relative mt-0 mr-0 z-30 rounded-full overflow-hidden `} style={{ "--value": perValue, "--size": `${size}`, "--thickness": `${widthPei}` }} role="progressbar"><span className={`text-black font-semibold ${sizeOfText}`}>70%</span></div>
